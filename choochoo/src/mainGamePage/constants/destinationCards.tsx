...
const destination_cards: DestinationCardInfo[] = [
  ...
  },
  {
    ...
    points: 9,
    imagePath: albTyville,
  },
  {
    destination1: "Chicago",
    destination2: "Miami",
    points: 7,
    imagePath: chicagoMiami,
  },
  {
    destination1: "Chicago",
    destination2: "Phoenix",
    points: 11,
    imagePath: chicagoPhoenix,
  },
  {
    destination1: "Clara City",
    destination2: "Houston",
    points: 9,
    imagePath: claraHouston,
  },
  {
    destination1: "Clara City",
  ...
  },
  {
    ...
    points: 9,
    imagePath: denverPalo,
  },
  {
    destination1: "Albuquerque",
    destination2: "Phoenix",
    points: 9,
    imagePath: firestonePhoenix,
  },
  {
  ...
  },
  {
    ...
    points: 9,
    imagePath: firestoneRiddhi,
  },
  {
    destination1: "Miami",
    destination2: "Riddhi Rapids",
    points: 18,
    imagePath: miamiRiddhi,
  },
  {
  ...
  },
  {
    ...
    destination2: "Phoenix",
    points: 12,
    imagePath: paloPhoenix,
  },
  {
    destination1: "Seattle",
    destination2: "Albuquerque",
    points: 10,
    imagePath: seattleAlb,
  },
  {
    destination1: "Seattle",
    destination2: "Houston",
    points: 15,
    imagePath: seattleHouston,
  },
  {
    destination1: "Tyville",
    destination2: "Palo Noah",
    points: 11,
    imagePath: tyvillePalo,
  },
  {
    destination1: "Tyville",
    destination2: "Phoenix",
    points: 7,
    imagePath: tyvillePhoenix,
  },
  {
    destination1: "Tyville",
    destination2: "Washington",
    points: 13,
    imagePath: tyvilleWash,
  },
  {
    destination1: "Washington",
    destination2: "Denver",
    points: 10,
    imagePath: washDenver,
  },
];
